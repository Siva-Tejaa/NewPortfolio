        ...
        <div
          ...
          className={
            activeItem === navItem?.name.toLowerCase()
              ? "flex flex-1 flex-col items-center cursor-pointer text-primary p-[5px] font-semibold"
              : "flex flex-1 flex-col items-center cursor-pointer p-[5px] font-semibold hover:text-primary"
          }
