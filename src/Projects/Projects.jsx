      ...
      <div className="grid grid-cols-[repeat(1,1fr)] gap-4 tablet:gap-8 tablet:grid tablet:grid-cols-[repeat(2,1fr)] laptop:grid laptop:grid-cols-[repeat(3,1fr)] laptop:gap-8">
        {projectsData.map((project) => (
          <a
            ...
            target="_blank"
            key={project?.id}
            className=" border-red-100 p-3 flex flex-col gap-2 bg-white rounded-md hover:bg-stone-50 w-80 tablet:w-[13rem] laptop:w-[14.5rem] laptop:p-3 desktop:w-72 projects"
          >
            <img
              src={project?.image}
              alt="project image"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center justify-center gap-2">
                <a
                  ...
                  target="_blank"
                  className="text-primary hover:text-[#8183f0]"
                >
